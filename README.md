...
Both scripts utilize specific VCF and reference FASTA genomes. For DGRP the VCF file can be downloaded [here](http://dgrp2.gnets.ncsu.edu/data/website/dgrp2.vcf) directly from DGRP. The reference FASTA file can be downloaded directly from UCSC Genome Browser [here](https://hgdownload.soe.ucsc.edu/goldenPath/dm3/bigZips/dm3.fa.gz). Both links will download the file immediately upon clicking. 
